...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <a href="index.html"><img src="<?php echo DOMAIN.ADM_TMPL; ?>images/logo.png" alt=""></a>
        </div>

        <div class="logo-icon text-center">
            <a href="index.html"><img src="<?php echo DOMAIN.ADM_TMPL; ?>images/logo_icon.png" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    <img alt="" src="<?php echo DOMAIN.ADM_TMPL; ?>images/photos/user-avatar.png" class="media-object">
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                <li class="new">
                                    <a href="">
                                        <span class="thumb"><img src="<?php echo DOMAIN.ADM_TMPL; ?>images/photos/user1.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="<?php echo DOMAIN.ADM_TMPL; ?>images/photos/user2.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="<?php echo DOMAIN.ADM_TMPL; ?>images/photos/user3.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="<?php echo DOMAIN.ADM_TMPL; ?>images/photos/user4.png" alt="" /></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="<?php echo DOMAIN.ADM_TMPL; ?>images/photos/user5.png" alt="" /></span>
                                        <span class="desc">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo DOMAIN.ADM_TMPL; ?>images/photos/user-avatar.png" alt="" />
                            John Doe
                        ...
                        <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                            ...
                            <li><a href="<?php echo DOMAIN; ?>/logout"><i class="fa fa-sign-out"></i> Log Out</a></li>
                        </ul>
                    </li>
